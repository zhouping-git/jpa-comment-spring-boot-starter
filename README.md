...
jpa-comment-spring-boot-starter 目前适配了五种数据库 PostgreSql、Mysql、Sqlserver、oracle、DB2，后期可以添加其他数据库。

jpa-comment-spring-boot-starter 的方法很简单将 java属性上的注解注释内容 修改到表字段里面。
